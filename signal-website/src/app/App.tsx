...
import { ArrowRight, ArrowUpRight, TrendingUp, Zap, Clock, BookOpen, Github, Copy, Check } from "lucide-react";
...
function InstallCommand() {
  ...
  return (
    <motion.div
      ...
      className="group relative flex items-center gap-3 px-4 py-3 border border-border hover:border-foreground/20 transition-all cursor-pointer"
      onClick={handleCopy}
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <motion.nav
        ...
        className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 bg-background/80 backdrop-blur-md"
        style={{ borderBottom: "1px solid rgba(13,13,11,0.07)" }}
      >
        {/* Logo */}
        <div className="relative flex items-center gap-3">
          <img src="/signal-logo-black.png" alt="Signal" className="h-9 w-auto" style={{ filter: "invert(1) brightness(1.5)" }} />
        </div>
        <div className="flex items-center gap-4">
          ...
          <motion.a
            href="https://github.com/PranavThe/Signal-SDK"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
            className="flex items-center gap-2 text-xs font-bold px-5 py-2.5 bg-foreground text-background hover:opacity-80 transition-opacity cursor-pointer"
      ...
      {/* ── Hero ── */}
      <section className="relative pt-36 pb-0 px-8 md:px-14 max-w-screen-xl mx-auto overflow-visible">
        <motion.div
        ...
        >
          ...
          <div className="mt-12 flex flex-col items-start gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              <motion.button
                onClick={scrollToForm}
                whileHover={{ scale: 1.04, gap: "14px" }}
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-2.5 px-8 py-4 bg-foreground text-background font-bold text-sm hover:opacity-90 transition-opacity cursor-pointer"
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center w-12 h-12 text-foreground hover:opacity-70 transition-opacity border border-border"
              >
      ...
      {/* ── Problem ── */}
      <section className="py-24 px-8 md:px-14 max-w-screen-xl mx-auto">
      ...
      {/* ── The Loop ── */}
      <section className="py-24 px-8 md:px-14 max-w-screen-xl mx-auto border-t border-border relative overflow-hidden">
      ...
      {/* ── Stack (dark) ── */}
      <section className="py-24 px-8 md:px-14 relative overflow-hidden" style={{ background: "#0d0d0b" }}>
      ...
      {/* ── Integration ── */}
      <section className="py-24 px-8 md:px-14 max-w-screen-xl mx-auto border-b border-border">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <Reveal delay={0.05}>
            ...
            >
              ...
              <pre className="p-7 text-sm leading-[1.9] overflow-x-auto" style={{ fontFamily: "'Geist Mono', monospace" }}>
                <code>
      ...
      {/* ── Moat ── */}
      <section className="py-32 px-8 md:px-14 max-w-screen-xl mx-auto relative overflow-hidden">
      ...
      {/* ── Real Competitor ── */}
      <section className="py-20 px-8 md:px-14 border-t border-border">
      ...
      <footer className="relative overflow-hidden" style={{ background: "#0d0d0b" }}>
        <div className="relative z-10 max-w-screen-xl mx-auto px-8 md:px-14 py-28">
          <Reveal y={24}>
            <h2
            ...
            <p className="text-sm mb-8 font-light" style={{ fontFamily: "'Manrope', sans-serif", color: "#6a6a67" }}>
              {"We're onboarding teams with active agent deployments. No pricing. No sales call required."}
            </p>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-3 max-w-xl">
              ...
              <textarea
                ...
                placeholder="Tell us about your AI agent deployment..."
                required
                rows={6}
