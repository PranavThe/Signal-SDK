              ...
              <Reveal>
                ...
                <div style={{ marginBottom: "3rem" }}>
                  ...
                  <ol style={{ paddingLeft: "1.5rem", lineHeight: 1.8, color: "#4a4a47", fontSize: "1.0625rem" }}>
                    <li>Open the Signal dashboard at <a href={DASHBOARD_URL} target="_blank" rel="noopener noreferrer" style={{ color: "#0d0d0b", fontWeight: 600 }}>{DASHBOARD_URL}</a></li>
                    <li>Create an account with your email address and password</li>
                ...
                <div style={{ marginBottom: "3rem" }}>
                  ...
                  <p style={{ marginBottom: "0.75rem", color: "#4a4a47", fontSize: "1.0625rem" }}>After sign-in, Signal starts at the Organizations page:</p>
                  <ol style={{ paddingLeft: "1.5rem", lineHeight: 1.8, color: "#4a4a47", fontSize: "1.0625rem" }}>
                    <li><strong>Create an organization:</strong> Enter your organization name and open it</li>
                    <li><strong>Choose a plan:</strong> Use Account Settings if you need more organizations or API keys per organization</li>
                    <li><strong>Create an API key:</strong> Open Organization Settings, click "Add new key", enter a name, then create it
                      <ul style={{ marginTop: "0.5rem" }}>
                        <li>Copy and save this key securely. Signal only shows it once</li>
                    ...
                    <li><strong>Choose review mode:</strong> Use dashboard-only review, or enable Slack plus dashboard review</li>
                  </ol>
                </div>

                <div style={{ marginBottom: "3rem" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "1rem", color: "#0d0d0b" }}>3. Install the SDK</h3>
                  <p style={{ marginBottom: "0.75rem", color: "#4a4a47", fontSize: "1.0625rem" }}>
                    The latest PyPI release is <strong>signalops {SIGNALOPS_VERSION}</strong>.
                  </p>
...
# Configure once. The hosted Signal API is the default base URL.
...
if result.decision in ["approve", "yes"]:
            ...
            <section id="dashboard-guide" style={{ marginBottom: "5rem", scrollMarginTop: "6rem" }}>
              <Reveal>
                ...
                <div style={{ marginBottom: "3rem" }}>
                  ...
                  <div style={{ display: "grid", gap: "1rem" }}>
                    {[
                      ...
                      { stage: "Stage 3: Review Rule", desc: "Review the AI-generated rule beside the source escalation, including exceptions, then approve, edit, or discard" }
                    ].map((s, i) => (
                ...
                <div style={{ marginTop: "3rem" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "1rem", color: "#0d0d0b" }}>Organization Settings Tab</h3>
                  <p style={{ color: "#4a4a47", fontSize: "1.0625rem" }}>
                    Manage API keys for the selected organization and choose whether reviews happen in the dashboard only or in Slack plus dashboard.
                  </p>
                </div>

                <div style={{ marginTop: "3rem" }}>
                  <h3 style={{ fontSize: "1.25rem", fontWeight: 600, marginBottom: "1rem", color: "#0d0d0b" }}>Account Settings</h3>
                  <p style={{ color: "#4a4a47", fontSize: "1.0625rem" }}>
                    Manage your subscription tier. The account plan controls how many organizations you can create and how many API keys each organization can have.
                  </p>
                </div>
              </Reveal>
            </section>
    ...
    base_url="https://signal-omega-tan.vercel.app"  # Optional; this is the default hosted API
)`}</pre>
                  </div>
                </div>
    ...
    agent_id="your-agent-identifier"
            ...
            <section id="security" style={{ marginBottom: "5rem", scrollMarginTop: "6rem" }}>
              <Reveal>
                ...
                <div>
                  ...
                  <ul style={{ paddingLeft: "1.5rem", lineHeight: 1.8, color: "#4a4a47", fontSize: "1.0625rem" }}>
                    <li>Only share organization access with trusted team members</li>
                    <li>Use Account Settings for subscription capacity and Organization Settings for API keys</li>
            ...
            <section id="troubleshooting" style={{ marginBottom: "5rem", scrollMarginTop: "6rem" }}>
              <Reveal>
                ...
                <div style={{ display: "grid", gap: "1rem" }}>
                  {[
                    { title: "\"No organization selected\" error", solution: "Go to Organizations, create or open an organization, then manage API keys in Organization Settings." },
                    { title: "Agent escalations not appearing", solution: "Check: API key is correct, base URL is https://signal-omega-tan.vercel.app unless self-hosting, and dashboard-only or Slack review is enabled as expected." },
                    { title: "Rules not triggering", solution: "Check: Rule status is Active, no active conflict is forcing escalation, and your action plus context match the rule." },
